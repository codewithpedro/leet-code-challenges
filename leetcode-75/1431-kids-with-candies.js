...
var kidsWithCandies = function(candies, extraCandies) {
    ...
    for (const num of candies) {
        const isHigher = num + extraCandies >= greatestNum;
        resultArray.push(isHigher);
    }
...
//Other Solutions
// Uses map to input the values of true and false

var kidsWithCandiesOne = function(candies, extraCandies) {
